NEW
10 REM  - /HOME/BILL/GIT/SETDATE/SETDATE.BAS - 01/02/2019 - 08h53
20 REM ***********************
...
90 GOSUB 1000
100 IF YEAR <> 0 AND MNTH <> 0 AND DAY <> 0 THEN GOTO 140
...
190 PRINT K$
200 IF K$ =  "N" THEN END 
210 IF K$ <> "Y" THEN GOTO 170
220 REM->ENTERYEAR
230 PRINT "YEAR (1-99) [RET FOR ";YEAR;"] ";
240 INPUT "";YEAR$
250 IF YEAR$ < > "" THEN YEAR = VAL(YEAR$)
260 IF 1 <= YEAR AND YEAR <= 99 THEN GOTO 330
270 INVERSE
...
360 IF 1 <= MNTH AND MNTH <= 12 MNTH THEN GOTO 430
370 INVERSE
...
460 IF 1 <= DAY AND DAY <= 31 THEN GOTO 530
470 INVERSE
...
560 IF 1 <= HOUR AND HOUR <= 12 THEN GOTO 630
570 INVERSE
...
660 IF 0 <= MINUTE AND MINUTE <= 59 THEN GOTO 730
670 INVERSE
...
760 IF AMPM$ = "A" OR AMPM$ = "P" OR AMPM$ = "AM" OR AMPM$ = "PM" THEN GOTO 830
770 INVERSE
...
1130 IF TH < 12 THEN HOUR = TH      : AMPM$ = "A"
1140 LET MINUTE = TL
1150 RETURN 
1160 REM->SETDATE
